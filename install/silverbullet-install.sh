...
cd /opt
curl -fsSL "https://github.com/silverbulletmd/silverbullet/releases/download/${RELEASE}/silverbullet-server-linux-aarch64.zip" -o "silverbullet-server-linux-aarch64.zip"
$STD unzip -o -d /opt/silverbullet/bin/ silverbullet-server-linux-aarch64.zip
...
rm -rf /opt/silverbullet-server-linux-aarch64.zip
