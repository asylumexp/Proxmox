...
if ! grep -q -m1 'avx[^ ]*' /proc/cpuinfo; then
  ...
  if ! dpkg -l | grep -q "libssl1.1"; then
    curl -fsSL "https://security.debian.org/debian-security/pool/updates/main/o/openssl/libssl1.1_1.1.1w-0+deb11u3_arm64.deb" -o "libssl1.1_1.1.1w-0+deb11u3_arm64.deb"
    $STD dpkg -i libssl1.1_1.1.1w-0+deb11u3_arm64.deb
  fi
