...
if ! grep -q -m1 'avx[^ ]*' /proc/cpuinfo; then
  ...
  if ! dpkg -l | grep -q "libssl1.1"; then
    curl -fsSL "http://security.debian.org/debian-security/pool/updates/main/o/openssl/libssl1.1_1.1.1n-0+deb10u6_arm64.deb" -o "libssl1.1_1.1.1n-0+deb10u6_arm64.deb"
