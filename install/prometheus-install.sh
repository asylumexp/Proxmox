...
curl -fsSL "https://github.com/prometheus/prometheus/releases/download/v${RELEASE}/prometheus-${RELEASE}.linux-arm64.tar.gz" -o "prometheus-${RELEASE}.linux-arm64.tar.gz"
