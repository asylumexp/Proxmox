...
curl -fsSL "https://github.com/mikefarah/yq/releases/download/${YQ_LATEST}/yq_linux_arm64" -o /usr/bin/yq
chmod +x /usr/bin/yq
msg_ok "Installed yq"
...
curl -fsSL "https://github.com/maxmind/geoipupdate/releases/download/v${GEOIP_RELEASE}/geoipupdate_${GEOIP_RELEASE}_linux_arm64.deb" -o "geoipupdate.deb"
