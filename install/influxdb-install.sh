...
if [[ $INFLUX == "2" ]]; then
  ...
  curl -fsSL "https://dl.influxdata.com/chronograf/releases/chronograf_1.10.8_arm64.deb" -o "/chronograf_1.10.8_arm64.deb"
  $STD dpkg -i chronograf_1.10.8_arm64.deb
  rm -rf /chronograf_1.10.8_arm64.deb
fi
